...
Проект содержит базовый runtime-модуль `Demo`, стандартный Third Person Content Pack и простую карту арены. Пользовательская игровая логика пока не реализована. Стартовая карта проекта:
